  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 sm:gap-4 w-full sm:w-auto">
      ...
      <div className="relative w-full sm:w-auto" ref={dropdownRef}>
        <div className="flex items-center w-full sm:w-auto rounded-full bg-[#19191D] border border-[#FDACAC]/18 focus-within:ring-2 focus-within:ring-[#FD7979] focus-within:border-transparent transition-all duration-200">
          <a
            href={PROFILE.resume}
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => setIsOpen(false)}
            className="flex-1 sm:flex-none h-12 sm:h-[52px] pl-7 pr-4 sm:pl-8 sm:pr-5 inline-flex items-center justify-center rounded-l-full text-[#FFFFFF] font-medium text-sm sm:text-base tracking-wide hover:bg-[#222228] active:scale-[0.98] transition-all duration-200"
          >
            Resume
          </a>
          <button
