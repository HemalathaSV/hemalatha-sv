  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 sm:gap-4 w-full sm:w-auto">
      ...
      <a
        ...
        className="h-12 sm:h-[52px] px-7 sm:px-8 w-full sm:w-auto inline-flex items-center justify-center rounded-full bg-[#5A4030] text-[#FFFFFF] font-semibold text-sm sm:text-base tracking-wide hover:bg-[#B18C6A] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-lg shadow-[#5A4030]/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5A4030]"
      >
        View My Work
      </a>
