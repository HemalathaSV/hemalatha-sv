      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start relative z-10">
          ...
          >
            ...
            {/* Description */}
            <p className="text-base sm:text-lg text-[#5B4A4A] leading-relaxed pt-2">
            ...
            <div className="pt-4 flex flex-wrap gap-2.5">
              {interests.map((interest, index) => (
                <span
                  key={index}
                  className="px-3.5 py-1.5 rounded-lg bg-[#FFF6F5] border border-[#FDACAC]/35 text-xs font-mono font-medium text-[#2B2323] hover:border-[#FDACAC]/40 hover:text-[#FD7979] transition-colors duration-200"
                >
                  {interest}
                </span>
              ))}
