...
export function PublicationCard({
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col justify-between p-6 sm:p-8 lg:p-10 rounded-2xl bg-[#19191D]/80 backdrop-blur-xl border border-[#FDACAC]/18 shadow-2xl transition-all duration-300 hover:border-[#FD7979]/40 hover:shadow-2xl hover:shadow-[#FD7979]/5 w-full"
    >
      ...
      <div className="flex flex-wrap items-center gap-3.5 pt-8 mt-6 border-t border-[#FDACAC]/18 relative z-10">
        <a
          ...
          className="h-11 px-6 rounded-full text-xs sm:text-sm font-semibold tracking-wide inline-flex items-center justify-center gap-2 bg-[#FD7979] text-[#0F0F12] hover:bg-[#FD7979]/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-md shadow-[#FD7979]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FD7979]"
        >
