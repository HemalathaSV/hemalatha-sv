...
export function PortfolioEngineeringSection() {
  ...
  return (
    <section className="relative py-16 sm:py-24 bg-[#0F0F12] overflow-hidden border-t border-[#FDACAC]/18">
      ...
      <Container>
        ...
        >
          ...
          <div className="group relative p-6 sm:p-10 lg:p-12 rounded-3xl bg-[#19191D]/90 backdrop-blur-xl border border-[#FDACAC]/18 shadow-2xl hover:border-[#FD7979]/40 transition-all duration-300 w-full overflow-hidden">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {techStack.map((tech, i) => (
                      <span
                        key={i}
                        className="px-3 py-1.5 rounded-xl bg-[#222228] border border-[#FDACAC]/18 text-xs font-mono text-[#B8B8C5] hover:border-[#FD7979]/30 transition-colors"
                      >
                        {tech}
                      </span>
                    ))}
            ...
            <div className="flex flex-wrap items-center gap-4 pt-8 mt-8 border-t border-[#FDACAC]/18 relative z-10">
              <a
                ...
                className="h-11 px-6 rounded-full text-xs sm:text-sm font-semibold tracking-wide inline-flex items-center justify-center gap-2.5 bg-[#FD7979] text-[#0F0F12] hover:bg-[#FD7979]/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-md shadow-[#FD7979]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FD7979]"
              >
