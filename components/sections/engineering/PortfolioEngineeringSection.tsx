...
export function PortfolioEngineeringSection() {
  ...
  return (
    <section className="relative py-16 sm:py-24 bg-[#050816] overflow-hidden border-t border-slate-900/60">
      {/* Ambient background glow */}
      <div
        aria-hidden="true"
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.06),transparent_70%)] blur-3xl pointer-events-none"
      />
      ...
      <Container>
        ...
        >
          ...
          <div className="flex flex-col space-y-4 text-center items-center">
            ...
            {/* Heading */}
            <h2 className="font-heading text-3xl sm:text-5xl font-bold tracking-tight text-[#F8FAFC]">
              Portfolio Engineering
            </h2>
          ...
          <div className="group relative p-6 sm:p-10 lg:p-12 rounded-3xl bg-[#0B1120]/90 backdrop-blur-xl border border-slate-800/80 shadow-2xl hover:border-[#38BDF8]/40 transition-all duration-300 w-full overflow-hidden">
            {/* Subtle backlight inside card */}
            <div
              aria-hidden="true"
              className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.05),transparent_70%)] pointer-events-none"
            />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 relative z-10">
              ...
              <div className="lg:col-span-7 flex flex-col justify-between space-y-8">
                ...
                <div className="space-y-3.5">
                  <h4 className="font-heading text-xs font-mono font-semibold text-[#F8FAFC] uppercase tracking-wider">
                    Technology Stack:
                  </h4>
                  <div className="flex flex-wrap gap-2">
                    {techStack.map((tech, i) => (
                      <span
                        key={i}
                        className="px-3 py-1.5 rounded-xl bg-[#111827] border border-slate-800 text-xs font-mono text-[#94A3B8] hover:border-[#38BDF8]/30 transition-colors"
                      >
                        {tech}
                      </span>
                    ))}
              ...
              <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-8 rounded-2xl bg-[#111827]/60 border border-slate-850/60 space-y-6">
                <div className="space-y-4">
                  <h4 className="font-heading text-xs font-mono font-semibold text-[#38BDF8] uppercase tracking-wider">
                    Engineering Highlights:
                  </h4>
                  <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3.5">
                    {highlights.map((item, i) => (
                      <li key={i} className="flex items-center gap-2.5 text-xs sm:text-sm text-[#94A3B8]">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-8 mt-8 border-t border-slate-800/80 relative z-10">
              <a
                href="https://github.com/HemalathaSV/hemalatha-sv"
                target="_blank"
                rel="noopener noreferrer"
                className="h-11 px-6 rounded-full text-xs sm:text-sm font-semibold tracking-wide inline-flex items-center justify-center gap-2.5 bg-[#38BDF8] text-[#050816] hover:bg-[#38BDF8]/90 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-md shadow-[#38BDF8]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#38BDF8]"
              >
