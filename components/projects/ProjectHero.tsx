    ...
    <section className="relative w-full pt-32 pb-20 sm:pt-40 sm:pb-24 bg-[#FFCDC9] overflow-hidden border-b border-[#FDACAC]/35">
      ...
      <Container>
        <div className="flex flex-col space-y-8 max-w-4xl mx-auto relative z-10">
          ...
          <Link
            href="/#featured-work"
            className="group inline-flex items-center gap-2.5 text-xs font-mono font-medium text-[#5B4A4A] hover:text-[#FD7979] transition-colors duration-300 self-start focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FD7979] rounded p-1"
          >
          ...
          <nav aria-label="Breadcrumb" className="text-xs font-mono text-[#5B4A4A] flex items-center gap-2 pt-2">
            ...
            <span className="text-[#2B2323] font-semibold">{project.title}</span>
          </nav>
