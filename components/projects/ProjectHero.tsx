    ...
    <section className="relative w-full pt-32 pb-20 sm:pt-40 sm:pb-24 bg-[#E4E0E1] overflow-hidden border-b border-[#D8C8BB]">
      ...
      <Container>
        <div className="flex flex-col space-y-8 max-w-4xl mx-auto relative z-10">
          ...
          <nav aria-label="Breadcrumb" className="text-xs font-mono text-[#5F5854] flex items-center gap-2 pt-2">
            <Link href="/" className="hover:text-[#5A4030] transition-colors">
              Portfolio
            </Link>
            <span className="text-slate-800">/</span>
            <Link href="/#featured-work" className="hover:text-[#5A4030] transition-colors">
              Featured Work
            </Link>
            <span className="text-slate-700">/</span>
            <span className="text-[#2E2A28] font-semibold">{project.title}</span>
          </nav>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <a
              ...
              className="h-12 px-6 rounded-full bg-[#5A4030] text-[#FFFFFF] font-semibold text-sm inline-flex items-center gap-2.5 hover:bg-[#B18C6A] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-[#5A4030]/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5A4030]"
            >
