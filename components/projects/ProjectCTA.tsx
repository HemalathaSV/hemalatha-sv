...
export function ProjectCTA({ project }: ProjectCTAProps) {
  return (
    <section className="py-20 sm:py-28 bg-[#151214] relative">
      <Container>
        <div className="max-w-3xl mx-auto text-center space-y-8 p-8 sm:p-12 rounded-3xl bg-[#19191D]/90 border border-[#FDACAC]/18 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 relative z-10">
            ...
            <Link
              href="/portfolio"
              className="h-12 px-7 rounded-full bg-transparent border border-[#FDACAC]/18 text-[#FFFFFF] font-medium text-sm inline-flex items-center gap-2 hover:bg-[#222228] hover:border-[#FDACAC]/40 active:scale-[0.98] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FD7979]"
            >
