    ...
    <section className="relative w-full pt-32 pb-20 sm:pt-40 sm:pb-24 bg-[#151214] overflow-hidden border-b border-[#FDACAC]/18">
      ...
      <Container>
        <div className="flex flex-col space-y-8 max-w-4xl mx-auto relative z-10">
          ...
          <Link
            href="/#featured-work"
            className="inline-flex items-center gap-2 text-xs font-mono font-medium text-[#B8B8C5] hover:text-[#FD7979] transition-colors self-start focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FD7979] rounded"
          >
